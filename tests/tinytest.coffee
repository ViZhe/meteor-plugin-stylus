...
stylusTest = (test_name, template_name, class_name, style_property, style_value) ->
    Tinytest.add test_name, (test) ->
        div = document.createElement('div')
        UI.render Template[template_name], div
        div.style.display = 'block'
        document.body.appendChild div

        p = div.querySelector('p.' + class_name)
        property = getStyleProperty(p, style_property)
